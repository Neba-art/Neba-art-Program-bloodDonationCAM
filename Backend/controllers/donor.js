...
// CREATE DONOR
const craeteDonor = async (req, res) => {
    try {
...
const getAlldonors = async (req, res) => {
    try {
        const donors = await Donor.find().sort({ craetedAt: -1 });
...
module.exports = { deleteDonor, getOneDonor, getAlldonors, getDonorsStats, updateDonor, craeteDonor }